                        ...
                        <div key={chat.id} className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all group relative overflow-hidden text-left">
                            ...
                            <div className="flex justify-between items-center pt-4 border-t border-white/5">
                                <button
                                    ...
                                    className="flex items-center space-x-1 text-primary-400 hover:text-primary-300 text-xs font-bold uppercase tracking-wider transition-colors"
                                >
                                ...
                                <button
                                    ...
                                    className="flex items-center space-x-1 text-red-400 hover:text-red-300 text-xs font-bold uppercase tracking-wider transition-colors"
                                >
